...
python %(prog)s --sync --runhooks --makefile --build --backup --download
    ...
    def _handle_ops(self):
        ...
        self.base = Base(args.is_debug, args.no_component_build, args.no_warning_as_error, args.dcheck, args.out_dir, self.program, self.rev, self.program.root_dir, args.symbol_level, self.target_arch, self.target_os)
        ops = 0
        if args.sync:
